...
public class QuizCardPlayer {
	...
	private void openFile() {
		...
		Path pathQuizCard = Paths.get("src/main/resources/savedfiles");
		File fileQuizCard = pathQuizCard.toFile();
		JFileChooser fileChooser = new JFileChooser(fileQuizCard.getAbsolutePath());
		...
		//						 * times, the array's length will be no greater than limit, and the array's last
